import {
  ...
  ToolsFeedbackFormPatternLearningControlPolicyEffectSchema,
  type ToolsFeedbackFormPatternLearningControlPolicyEffect,
} from "./schemas.js";
import { deriveControlledStateRaisePreview } from "./learning-control-shared.js";
...
export function deriveFormPatternLearningControlPolicyEffect(args: {
...
}): ToolsFeedbackFormPatternLearningControlPolicyEffect {
  ...
  const derived = deriveControlledStateRaisePreview({
    ...
    reviewSource: "form_pattern_learning_control_review",
  ...
  return ToolsFeedbackFormPatternLearningControlPolicyEffectSchema.parse({
