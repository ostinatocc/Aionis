...
export type PromoteMemoryLearningControlCandidateExample = {
  node_id: string;
  title?: string | null;
  summary?: string | null;
...
function compactExamples(examples: PromoteMemoryLearningControlCandidateExample[]): PromoteMemoryLearningControlCandidateExample[] {
