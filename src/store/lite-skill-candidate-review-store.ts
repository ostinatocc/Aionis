        ...
        for (const candidate of args.candidates) {
          ...
          if (!existing) {
            insertStmt.run(
              ...
              candidate.reason,
              stableJson(candidate.source_ids),
              stableJson(skill.source_trace_ids),
              stableJson(skill.source_signal_ids),
              stableJson(skill.applies_when),
              stableJson(skill.does_not_apply_when),
              stableJson(skill.procedure_steps),
              stableJson(skill.target_files),
              stableJson(skill.acceptance_checks),
              stableJson(skill.failure_counterexamples),
              stableJson(skill.evidence_refs),
