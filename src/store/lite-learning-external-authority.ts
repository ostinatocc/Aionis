...
/**
 * Canonical read/verification primitives shared with the private operator
 * authority package. This object deliberately contains no database mutation or
 * transaction capability; the Runtime daemon only loads the verifier side.
 *
 * @internal
 */
export const liteLearningExternalAuthorityCanonicalContract = Object.freeze({
  BoundedIdSchema,
