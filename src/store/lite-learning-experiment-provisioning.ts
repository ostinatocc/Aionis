...
function buildConfirmatoryApplicabilityCohort(args: {
...
function buildApplicabilityManifestFromDatabase(args: {
  db: SqliteDatabase;
  tenantId: string;
  experimentId: string;
  experimentRevision: number;
  ...
  ).get(args.tenantId, args.experimentId, args.experimentRevision) as Record<string, unknown> | undefined;
  ...
  const sourcePolicy = canonicalJsonObject(
