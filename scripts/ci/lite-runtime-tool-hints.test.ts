...
test("buildRuntimeToolHintsFromAnchorNodes prefers canonical execution contract when selected tool conflicts with stale slots", () => {
  const hints = buildRuntimeToolHintsFromAnchorNodes({
    tenant_id: "default",
    scope: "default",
    nodes: [
      {
        ...
        slots: {
          ...
          execution_contract_v1: buildExecutionContractFromProjection({
            ...
            pattern_hints: ["canonical contract overrides stale stale slots"],
            provenance: {
