    ...
    const result = {
      ...
      collector: collectionResult
        ? {
          ...
          shadow_policy_path: collectionResult.shadow_policy_path,
          shadow_policy_markdown_path: collectionResult.shadow_policy_markdown_path,
          ...
          shadow_policy_changed_action_count: collectionResult.shadow_policy?.delta.changed_action_count ?? null,
          shadow_policy_would_downgrade_use_now_count: collectionResult.shadow_policy?.delta.would_downgrade_use_now_count ?? null,
        }
        : null,
