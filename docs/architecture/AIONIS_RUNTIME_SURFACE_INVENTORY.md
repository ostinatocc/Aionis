...
| `GET` | `/v1/runtime/boundary-inventory` | `operator_support` | `routes/runtime-boundary-inventory.ts` | `none` | `none` | `none` | `CLI boundary and doctor` | `none` | `none` | `none` | `docs:operator` | `required` | `none` | `retain` |
